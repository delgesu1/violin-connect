...
**Generated on:** Thu Mar 20 04:44:09 EDT 2025
...
```
Total hooks missing dev-uuid imports: 37
...
src/features/repertoire/hooks/useMasterRepertoire.ts:          setCachedMockData(cacheKey, mockPiece);
src/features/repertoire/hooks/useMasterRepertoire.ts:        setCachedMockData('masterRepertoire', [...existingData, mockPiece]);
src/features/repertoire/hooks/useMasterRepertoire.ts:      setCachedMockData(`masterRepertoire_${data.id}`, data);
src/features/repertoire/hooks/useMasterRepertoire.ts:        setCachedMockData('masterRepertoire', updatedData);
src/features/repertoire/hooks/useMasterRepertoire.ts:        setCachedMockData(`masterRepertoire_${id}`, updatedPiece);
src/features/repertoire/hooks/useMasterRepertoire.ts:      setCachedMockData(`masterRepertoire_${data.id}`, data);
src/features/repertoire/hooks/useMasterRepertoire.ts:        setCachedMockData('masterRepertoire', updatedData);
src/features/repertoire/hooks/useMasterRepertoire.ts:        setCachedMockData(`masterRepertoire_${id}`, null);
src/features/repertoire/hooks/useMasterRepertoire.ts:      setCachedMockData(`masterRepertoire_${data.id}`, null);
...
src/hooks/useStudents.ts:          setCachedMockData('students', mockStudentsWithUuids);
src/hooks/useStudents.ts:            setCachedMockData(cacheKey, data);
src/hooks/useStudents.ts:            setCachedMockData(cacheKey, convertedStudent);
...
src/features/repertoire/hooks/useMasterRepertoire.ts:        const cachedData = getCachedMockData<MasterRepertoire[]>(cacheKey, []);
src/features/repertoire/hooks/useMasterRepertoire.ts:        const cachedPiece = getCachedMockData<MasterRepertoire>(cacheKey, null);
...
### isValidUUID usage
```
src/features/repertoire/hooks/useMasterRepertoire.ts:import { isValidUUID } from '@/lib/id-utils';
src/features/repertoire/hooks/useMasterRepertoire.ts:        if (isValidUUID(id)) {
src/features/repertoire/hooks/useMasterRepertoire.ts:      if (!isValidUUID(id) && !isDevelopmentMode) {
src/features/repertoire/hooks/useMasterRepertoire.ts:      if (!isValidUUID(id) && !isDevelopmentMode) {
...
src/features/dashboard/pages/Dashboard.tsx:import { ID_PREFIXES, createPrefixedId, isValidUUID } from '@/lib/id-utils';
src/hooks/useStudents.ts:import { isValidUUID } from '@/lib/id-utils';
src/hooks/useStudents.ts:        if (!isValidUUID(userUuid)) {
src/hooks/useStudents.ts:        if (isValidUUID(id)) {
...
src/hooks/useRepertoireAttachments.ts
```
Total hooks potentially missing UUID validation: 15
...
src/features/repertoire/hooks/useMasterRepertoire.ts:        return mockData.map(item => ({...item, _source: 'mock'}));
src/features/repertoire/hooks/useMasterRepertoire.ts:          return cachedData.map(item => ({...item, _source: 'cached-error-fallback'}));
src/features/repertoire/hooks/useMasterRepertoire.ts:        return generateMockMasterRepertoire().map(item => ({...item, _source: 'mock-error-fallback'}));
src/features/repertoire/hooks/useMasterRepertoire.ts:  return useQuery<(MasterRepertoire & { _source?: string }) | null>({
src/features/repertoire/hooks/useMasterRepertoire.ts:        const allMasterRepertoire = queryClient.getQueryData<(MasterRepertoire & { _source?: string })[]>(['masterRepertoire']);
...
src/features/repertoire/hooks/useMasterRepertoire.ts:          return { ...mockPiece, _source: 'mock' };
src/features/repertoire/hooks/useMasterRepertoire.ts:        return { ...mockPiece, _source: 'mock-created' };
src/features/repertoire/hooks/useMasterRepertoire.ts:      return { ...data, _source: 'database-created' } as MasterRepertoire & { _source: string };
src/features/repertoire/hooks/useMasterRepertoire.ts:        return { ...updatedPiece, _source: 'mock-updated' };
src/features/repertoire/hooks/useMasterRepertoire.ts:      return { ...data, _source: 'database-updated' } as MasterRepertoire & { _source: string };
src/features/repertoire/hooks/useMasterRepertoire.ts:        return { id, _source: 'mock-deleted' };
src/features/repertoire/hooks/useMasterRepertoire.ts:      return { id, _source: 'database-deleted' };
...
src/hooks/useStudentProfile.ts:              _source: 'cached-fallback'
src/hooks/useStudentProfile.ts:            _source: 'mock-fallback'
src/hooks/useStudents.ts:  _source?: 'database' | 'cached' | 'mock' | 'cached-fallback' | 'mock-fallback' | 'mock-created' | 'mock-updated' | 'mock-deleted';
src/hooks/useStudents.ts:            _source: 'database'
src/hooks/useStudents.ts:            _source: 'cached'
src/hooks/useStudents.ts:              _source: 'mock' as const // Use const assertion for type safety
src/hooks/useStudents.ts:              _source: 'cached-fallback'
src/hooks/useStudents.ts:              _source: 'mock-fallback' as const // Use const assertion for type safety
src/hooks/useStudents.ts:              _source: 'database'
src/hooks/useStudents.ts:            _source: 'cached'
...
| ID Prefix Creation | 53 |
| Missing UUID Imports | 37 |
| Missing Hybrid Caching | 13 |
| Missing UUID Validation | 15 |
