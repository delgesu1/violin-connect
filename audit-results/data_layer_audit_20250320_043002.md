...
**Generated on:** Thu Mar 20 04:30:02 EDT 2025
...
### Pattern: 'p-[0-9]
```
src/features/repertoire/hooks/useStudentRepertoire.ts:            master_piece_id: 'p-1',
src/features/repertoire/hooks/useStudentRepertoire.ts:            master_piece_id: 'p-2',
src/features/repertoire/hooks/useStudentRepertoire.ts:            master_piece_id: 'p-3',
src/features/dashboard/pages/Dashboard.tsx:    id: 'p-1',
src/features/dashboard/pages/Dashboard.tsx:    id: 'p-9',
...
src/features/dashboard/pages/Dashboard.tsx:import { ID_PREFIXES, createPrefixedId } from '@/lib/id-utils';
...
src/data/defaultRepertoire.ts:import { ID_PREFIXES, createPrefixedId } from "@/lib/id-utils";
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '1'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '2'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '3'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '4'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '5'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '6'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '7'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '8'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '9'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '10'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '11'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '12'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '13'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '14'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '15'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '16'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '17'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '18'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '19'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '20'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '21'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '22'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '23'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '24'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '25'),
src/data/defaultRepertoire.ts:    id: createPrefixedId(ID_PREFIXES.PIECE, '26'),
...
src/features/repertoire/hooks/useStudentRepertoire.ts
...
```
Total hooks missing dev-uuid imports: 40
...
src/hooks/useRepertoireAttachments.ts
```
Total hooks potentially missing UUID validation: 18
...
src/features/repertoire/hooks/useStudentRepertoire.ts:          return data.map(item => ({ ...item, _source: 'api' }));
src/features/repertoire/hooks/useStudentRepertoire.ts:          return cachedData.map(item => ({ ...item, _source: 'cache' }));
src/features/repertoire/hooks/useStudentRepertoire.ts:          return cachedData.map(item => ({ ...item, _source: 'cache' }));
...
| ID Prefix Creation | 86 |
| Missing UUID Imports | 40 |
| Missing Hybrid Caching | 13 |
| Missing UUID Validation | 18 |
